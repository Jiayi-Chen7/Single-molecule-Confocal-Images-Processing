function [CytoSingleGFPMask,GauGFPFil] = SinglePlaneGFPMaskAdjTh_cjy01(SingleGFP,SinglePlaneNuc,ExGFPCore,IxGFPCore,IndexOfZstack,GauKer)
%%
...
RawGFPMask = imbinarize(AdjOutims,ThVal(ElbowPointIndexRelative)-0.1);
