function [ventralData, dorsalData, APlength, AP_x, AP_y,NormAPn] = convertXY2AP_PlotEmBand(intens, nx, ny, emmask, fig,flipAP) %(NucleiIntensity, NucleiPosition(:,1), NucleiPosition(:,2), embryomask, fig)
