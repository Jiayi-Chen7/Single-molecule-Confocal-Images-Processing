function [MOVINGREG,ErrorMteric] = RegisterImages(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 11-Feb-2022
%-----------------------------------------------------------
...
%cjy modified,output parameters
[tform,inlierpoints1,inlierpoints2] = estimateGeometricTransform(movingMatchedPoints,fixedMatchedPoints,'affine');
MOVINGREG.Transformation = tform;
MOVINGREG.RegisteredImage = imwarp(MOVING, movingRefObj, tform, 'OutputView', fixedRefObj, 'SmoothEdges', true);

% Store spatial referencing object
MOVINGREG.SpatialRefObj = fixedRefObj;
TenStrongestPoint1 = inlierpoints1.selectStrongest(10);
TenStrongestPoint2 = inlierpoints2.selectStrongest(10);
DiffPoint = TenStrongestPoint2.Location - TenStrongestPoint1.Location;
SquareDiffPoint = DiffPoint.^2;

ErrorMteric = sum(sum(SquareDiffPoint));
MOVINGREG.ErrorMteric = ErrorMteric;
end
