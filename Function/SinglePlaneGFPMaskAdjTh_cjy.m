function [CytoSingleGFPMask,GauGFPFil] = SinglePlaneGFPMaskAdjTh_cjy(SingleGFP,SinglePlaneNuc,ExGFPCore,IxGFPCore,IndexOfZstack,GauKer)
%%
...
RawGFPMask = imbinarize(AdjOutims,ThVal(ElbowPointIndexRelative)-0.05);
