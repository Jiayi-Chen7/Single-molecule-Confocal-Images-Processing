function [CytoSingleRNAMask,Gauoutims] = SinglePlaneRNAMaskLocalMax_cjy_output(SinglemRNA,SinglePlaneNuc,ExRNACore,IxRNACore,IndexOfZstack,mRNAFociRawMaskPlane)
%%
